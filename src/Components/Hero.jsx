...
const Hero = () => {
    return (
        ...
        style={{ 
            ...
            height: '100vh', 
            width: '100%',
            backgroundSize: 'cover', // Default: Fill the container
            backgroundPosition: 'center', // Default: Center the image horizontally and vertically
            '@media (maxWidth: 600px)': { // Changed max-width to maxWidth
                backgroundSize: 'contain' // On devices with a maximum width of 600px (phones), show the entire image without cropping
            }
        }}
        >

            <div className="col-start-1 row-start-1 bg-gray-800 bg-opacity-70 "></div>
