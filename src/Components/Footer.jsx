      ...
      <div className="py-4 m-5">
        <div className="container px-4 mx-auto">
          <div className="-mx-4 flex flex-wrap justify-between">
            <div className="logo flex items-center justify-center text-center sm:ml-0 mr-10">
            ...
            <div className="px-4 my-4 w-full sm:w-auto">
              <div>
                <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 border-blue-600">Services</h2>
              </div>
            ...
            <div className="px-4 my-4 w-full sm:w-auto">
              ...
              <ul className="leading-8">
                ...
                <li><a href="#aobut" className="hover:text-blue-400">À Propos</a></li>
            ...
            <div className="px-4 my-4 w-full sm:w-auto xl:w-1/5">
              <div>
                <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 border-blue-600">Connectez Avec Nous</h2>
              </div>
      ...
      <div className="py-4">
        <Row justify="center" align="middle">
          <Col className="text-center">
            <p className="text-gray-600">ConsultaMed &copy; {new Date().getFullYear()}. Tous droits réservés.</p>
          </Col>
        </Row>
      </div>
    </footer>
