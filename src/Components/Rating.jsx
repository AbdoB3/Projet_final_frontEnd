...
function Rating() {
  ...
  const ratings = [
    ...
    { name: "Jane Smith", rating: "5", comment: "Je recommande fortement ! Le médecin était très compétent et serviable." },
                  ...
                  <figure className="relative rounded-2xl bg-white p-6 shadow-xl shadow-slate-900/10">
                    ...
                    <figcaption className="relative mt-6 flex items-center justify-between border-t border-slate-100 pt-6">
                      ...
                      <div className="overflow-hidden rounded-full bg-slate-50">
                        <img alt="" className="h-14 w-14 object-cover" src={getRandomUserImage(getGenderFromName(rating.name))} />
                      </div>
                    </figcaption>
                  </figure>
                </li>
